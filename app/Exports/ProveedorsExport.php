...
class ProveedorsExport implements
    WithColumnWidths,
    WithHeadings,
    FromCollection,
    WithProperties,
    WithTitle
{
    ...
    {
        return 'Informe Proveedor';
    }
    public function properties(): array
    {
        return [
            'creator'        => 'Crearte',
            'title'          => 'Informe Proveedor',
        ];
    }
    ...
    public function informeProveedor()
    {
        try {
            ...
            $productos = Producto::with('proveedor', 'unidad')->where('producto_proveedor_id', $this->id)->get();
