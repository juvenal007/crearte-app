...
class CreateSolicitudsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('solicituds', function (Blueprint $table) {
            $table->id();
            $table->string('solicitud_codigo', 20);
            ...
            $table->unsignedBigInteger('solicitud_tipo_solicitud_id')->nullable();
            $table->foreign('solicitud_tipo_solicitud_id')->references('id')->on('tipo_solicituds')->onDelete('set null');
